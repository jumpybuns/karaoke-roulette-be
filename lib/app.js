...
app.delete('/favorites/:booger', async(req, res) => {
  try {
...
app.get('/videos', async(req, res) => {
  try {
    const response = await request.get(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&q=${req.query.search}&key=${process.env.YOUTUBE_API_KEY}`);
