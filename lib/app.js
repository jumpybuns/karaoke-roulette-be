...
app.get('/api/random-videos', async(req, res) => {
  try {
    const URL = (`https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UCwTRjvjVge51X-ILJ4i22ew&maxResults=500&q=karaoke%20%22karaoke%20version%22&relevanceLanguage=en&safeSearch=none&type=video&videoEmbeddable=true&key=${req.query.search}%20karaoke%20version&type=video&videoEmbeddable=true&key=${process.env.YOUTUBE_API_KEY}`);
